    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#FFFFFF' }} edges={['top', 'left', 'right']}>
        ...
        >
          ...
          >
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' }}>
              <View style={{ gap: 4, flex: 1 }}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
                  <Text style={{ fontSize: 32, fontWeight: '600', color: '#000000', lineHeight: 38 }}>
              ...
              >
                ...
                <Text style={{ fontSize: 10, fontWeight: '400', letterSpacing: 0.48, color: '#574500', lineHeight: 14 }}>
                  Premium
                </Text>
              </View>
            </View>
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                <Text style={{ fontSize: 12, fontWeight: '500', letterSpacing: 0.48, color: '#000000', opacity: 0.8 }}>
                  Eco-Points
                </Text>
                <View style={{ flexDirection: 'row', alignItems: 'baseline', gap: 4 }}>
                  <Text style={{ fontSize: 20, fontWeight: '400', color: '#31973D', lineHeight: 28 }}>
                    {ecoPoints}
                  </Text>
              ...
              <MaterialCommunityIcons name="chevron-right" size={12} color="#ACB5BB" opacity={0.6} />
            </View>
          </View>
          ...
          <View style={{ width: '95%', flexDirection: 'row', gap: 10 }}>
            <Pressable
              style={{
                flex: 1,
                height: 91,
                backgroundColor: activeSheet === 'withdraw' ? '#FFFFFF' : '#31973D',
            ...
            <Pressable
              style={{
                flex: 1,
                height: 91,
                backgroundColor: activeSheet === 'withdraw' ? '#31973D' : '#FFFFFF',
              ...
              <View>
                ...
                >
                  {MOCK_TRANSACTIONS.map((tx, i) => (
                    <TransactionRow key={tx.id} tx={tx} isLast={i === MOCK_TRANSACTIONS.length - 1} />
                  ))}
                </View>
                ...
                >
                  <Text style={{ fontSize: 14, fontWeight: '500', color: '#1F2A33', letterSpacing: 0.28 }}>
              ...
              >
                <View style={{ alignItems: 'center', gap: 24 }}>
                  ...
                  <View style={{ alignItems: 'center', gap: 4, paddingHorizontal: 24 }}>
                    <Text style={{ fontSize: 16, fontWeight: '600', color: '#1F2A33', textAlign: 'center', lineHeight: 24 }}>
                      No transaction yet
                    </Text>
                    <Text style={{ fontSize: 14, fontWeight: '400', color: '#64748A', textAlign: 'center', lineHeight: 20 }}>
      ...
      >
        <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.4)', justifyContent: 'flex-end' }}>
          ...
          {/* Payment method list */}
          <View style={{ width: '100%', paddingHorizontal: 20, gap: 0 }}>
                  ...
                  <View style={{ flexDirection: 'row', alignItems: 'center', gap: 16 }}>
                    <View
                      style={{
                        ...
                        alignItems: 'center',
                        justifyContent: 'center',
                        borderWidth: method.key === 'airtel' ? 1 : 0,
                        borderColor: method.key === 'airtel' ? '#E2E8F0' : 'transparent',
                      }}
                    >
                      {method.badgeIcon ? (
                        ...
                        <Text
                          style={{
                            fontSize: 12,
                            fontWeight: method.badgeFontWeight,
                            color: method.badgeLabelColor,
                            lineHeight: 15,
                          }}
                        >
                          {method.badgeLabel}
                    ...
                    <Text style={{ fontSize: 14, fontWeight: '400', color: '#1C1B1B', lineHeight: 24 }}>
                      {method.name}
                    </Text>
                  </View>
